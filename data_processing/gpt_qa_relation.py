...
if __name__ == '__main__':
    output_path = "GPT_QA_RELATION.json"
    caption_list = []
    ...
    ## Task
    Based on these facts, Your task is to generate several questions related to the positional relation of surgical instruments.

    ### Few Examples
    -	"Question: Is the grasper on the top of the hook? Answer: No, the grasper is at the bottom of the hook.",
    -	"Question: Where is the hook near the grasper? Answer: Yes, it is near the grasper."
   -	"Question: What is the relationship between the grasper and the clip? Answer: The grasper is at the left of the clip."
