...
if __name__ == '__main__':
    output_path = "GPT_QA_MOVEMENT.json"
    caption_list = []
    ...
    ## Task
    Based on these facts, Your task is to generate several questions related to the positional movement of surgical instruments.

    ### Few Examples
    -	"Question: How is the movement of the grasper in the video? Answer: The grasper is moving from the bottom to the center in the video.",
    -	"Question: How the hook moves during the video? Answer: The hook moves from the left to the right."
   -	"Question: Is the clip moving from center to the top? Answer: No, the clip is not moving in the video, it keeps in the center."
