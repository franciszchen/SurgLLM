...
if __name__ == '__main__':
    output_path = "GPT_QA_LOCATION.json"
    caption_list = []
    ...
    ## Task
    Based on these facts, Your task is to generate several questions related to the location of surgical instruments.

    ### Few Examples
    -	"Question: What are the instruments and where are they? Answer: The grasper at first is in the center, then moving to the right side. The hook keeps in the left area.",
    -	"Question: Where is the hook at first? Answer: The hook is at the top of the endoscopic scene."
   -	"Question: Where is the clip at the end of the video? Answer: The clip is not shown at the end ."
   -	"Question: What is the location of the grasper? Answer: It is at the right side."
    ...
    for i in tqdm(window_list): 
        ...
        #TODO 1.保证所有的seg_sec都是同一个folder e.g. 68VID，如果不是的话就跳过 done
        #TODO 2.记录一个包含的seg_sec的起始和结束 done
        seg_sec = []
        for index in i:
            cap_dict = {}
