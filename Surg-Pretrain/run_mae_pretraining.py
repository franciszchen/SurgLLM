...
def get_args():
    ...
    #读取一个csv文件，包含video-frame-mask
    parser.add_argument("--mask_path",default=None,help="a folder contains the bbox annotation of each video")

    parser.add_argument("--mask_tube_len",type=int,default=None,help="mask_tube_length")
