...
from dataset.masking_generator import  TubeMaskingGenerator
...
def get_args():
    ...
    parser.add_argument('--img_path', default="",type=str, help='input video path')
    parser.add_argument('--save_path', default="visualization_surg",type=str, help='save video path')
    parser.add_argument('--model_path', default="",type=str, help='checkpoint path of model')
    ...
    # Model parameters
    parser.add_argument('--model', default='pretrain_videomae_giant_patch14_224', type=str, metavar='MODEL',
...
def main(args):
    ...
    with torch.no_grad():
        ...
        mask = rearrange(mask, 'b (t h w) (p0 p1 p2) c -> b c (t p0) (h p1) (w p2) ', p0=2, p1=patch_size[0], p2=patch_size[1], h=16, w=16)
        ...
        rec_img = rearrange(rec_img, 'b (t h w) (p0 p1 p2) c -> b c (t p0) (h p1) (w p2)', p0=2, p1=patch_size[0], p2=patch_size[1], h=16, w=16)
