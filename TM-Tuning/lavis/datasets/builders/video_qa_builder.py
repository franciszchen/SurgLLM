...
from lavis.datasets.datasets.cholec_video_caption_datasets import CholecVideoCaptionDataset
from lavis.datasets.datasets.cholec_video_qa_datasets import CholecVideoQADataset
...
@registry.register_builder("cholect50")
class CholecVideoCaptionBuilder(MultiModalDatasetBuilder):
    train_dataset_cls = CholecVideoCaptionDataset
    eval_dataset_cls = CholecVideoCaptionDataset

    DATASET_CONFIG_DICT = {"default": "configs/datasets/cholect50/defaults.yaml"}


@registry.register_builder("cholect50QA")
class CholecVideoQABuilder(MultiModalDatasetBuilder):
    train_dataset_cls = CholecVideoQADataset
    eval_dataset_cls = CholecVideoQADataset

    DATASET_CONFIG_DICT = {"default": "configs/datasets/cholect50/defaults_qa.yaml"}

@registry.register_builder("cholect50QACONV")
class CholecVideoTimeQABuilder(MultiModalDatasetBuilder):
    train_dataset_cls = CholecVideoQADataset
    eval_dataset_cls = CholecVideoQADataset

    DATASET_CONFIG_DICT = {"default": "configs/datasets/cholect50/defaults_qa_conv.yaml"}
