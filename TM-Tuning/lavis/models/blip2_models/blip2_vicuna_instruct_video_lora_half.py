...
@registry.register_model("blip2_vicuna_instruct_video_lora_half")
class Blip2VicunaInstructVideoLoRAHALF(Blip2Base):
    """
    BLIP2 Vicuna model.
    ...
    def __init__(
        ...
        self.llm_proj.load_state_dict(torch.load(llm_proj_path,map_location="cuda:0"))
