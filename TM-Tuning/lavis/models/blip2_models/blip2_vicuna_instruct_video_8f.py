...
@registry.register_model("blip2_vicuna_instruct_video_8f")
class Blip2VicunaInstructVideo_8f(Blip2Base):
    """
    BLIP2 Vicuna model.
    ...
    def get_video_tensor(self,vid_tube):
        ...
        vision_embeds, pooled_vision_embeds, _, _  = self.visual_encoder.vision_encoder(vid_tube, None, use_image) #input video, mask, use_image?
    ...
    def warp_video_embedding_with_words(self,query_output_list,query_tokens,cur_device,frame=8):
        # print("============================================")
