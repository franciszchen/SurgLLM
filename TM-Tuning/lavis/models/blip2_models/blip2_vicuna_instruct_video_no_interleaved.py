...
@registry.register_model("blip2_vicuna_instruct_video_no_interleaved")
class Blip2VicunaInstructVideo_NO_INTERLEAVED(Blip2Base):
    """
    BLIP2 Vicuna model.
    ...
    def warp_video_embedding_with_words(self,query_output_list,query_tokens,cur_device):
        ...
        for i in range(len(query_output_list)):
            if i == 0:
                ...
                attention_mask = atts_llm_ #mixed input atts
            else:
