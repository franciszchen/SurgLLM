...
config.model.vision_encoder["num_frames"] = 16
config.model.text_encoder["pretrained"] = "/data/xingjian_luo/checkpoint/bert-large-uncased"




@registry.register_model("blip2_vicuna_instruct_video_16f")
class Blip2VicunaInstructVideo_16f(Blip2Base):
    """
    BLIP2 Vicuna model.
    ...
    def frames2tensor(self,vid_list, fnum=16, target_size=(224, 224), device=torch.device('cuda')):
    ...
    def warp_video_embedding_with_words(self,query_output_list,query_tokens,cur_device,frame=16):
        # print("============================================")
