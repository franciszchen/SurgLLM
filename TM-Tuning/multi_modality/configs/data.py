...
available_corpus = dict(
    ...
    cholect50=dict(
        anno_path="/data/xingjian_luo/dataset/cholect50-challenge-val/stage2_cholec50_caption.json", 
        data_root="",
        media_type="video",
        jump_filter=True
    ),
    cholect50_short_train=dict(
        anno_path="/data/xingjian_luo/dataset/cholect50-challenge-val/caption_short_train.json", 
        data_root="",
        media_type="video",
        jump_filter=True
    ),
    cholect50_short_test=dict(
        anno_path="/data/xingjian_luo/dataset/cholect50-challenge-val/caption_short_test.json", 
        data_root="",
        media_type="video",
        jump_filter=True
    ),
