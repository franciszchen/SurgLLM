...
class InternVideo2_Stage2(nn.Module):
    ...
    def __init__(self, config, tokenizer, is_pretrain=True):
        ...
        self.vision_width = config.model.vision_encoder.clip_embed_dim #768
        self.text_width = config.model.text_encoder.d_model #1024
        self.embed_dim = config.model.embed_dim #512

        # create modules.
        #TODO 重写这个 vision encoder
